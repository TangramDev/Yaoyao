...
class CChromeWebFrameClient {
 public:
  ...
  virtual void OnHubbleExtend(std::wstring strXml,
                               std::wstring strKey,
  ...
  virtual void SendHubbleMessage(std::wstring strChannel,
	  std::wstring strArg1,
	  std::wstring strArg2) {};

  virtual void OnHubbleMessage(std::wstring strChannel,
	  std::wstring strArg1,
	  std::wstring strArg2) {};
};
